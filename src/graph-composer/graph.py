# this is our Markov chain represenation
...
class Vertex(object):
    def __init__(self, value):  # value will be the word
        self.value = value
        self.adjacent = {}  # nodes that it points to.. nodes that have an edge from this vertex
        self.neighbors = []
    ...
    def add_edge_to(self, vertex, weight=0):
        # this is adding edge to the vertex we input with weight
