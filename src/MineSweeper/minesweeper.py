...
class Board:
    def __init__(self, dim_size, num_bombs):
        ...
        # initialize the set to keep track of which locations we have uncovered
...
def play(dim_size=10, num_bombs=10):  # play the game
    # step 1: create the board and plant the bombs
    board = Board(dim_size, num_bombs)

    # step 2: show the user the board and ask for where they want to dug

    # step 3a: if location is a bomb, show game over message

    # stpe 3b: if location is not a bomb, dig recursively until each square is at least next to bomb
