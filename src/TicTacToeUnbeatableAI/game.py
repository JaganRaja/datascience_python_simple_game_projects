...
class TicTacToe:
    ...
    def make_move(self, square, letter):
        ...
        if self.board[square] == ' ':
            ...
            # after move we need to check the winner
    ...
    def winner(self, square, letter):
        # winner if 3 in a row/column/diagonal.. we have to check all of these!
...
def play(game, x_player, o_player, print_game=True):
    ...
    while game.empty_squares():
        ...
        if game.make_move(square, letter):
            ...
            # after we made our move, we need to alternate thr letters
        ...
        # random computer player vs genuis computer player
        if print_game:
            time.sleep(0.8)
...
if __name__ == '__main__':
    ...
    print(
        f"After 10 iterations, we see {x_wins} X wins, {o_wins} O wins, {ties} ties")
